...
import com.nttdata.bankservice.api.AccountController;
import com.nttdata.bankservice.model.document.Account;
import com.nttdata.bankservice.model.document.type.AccountMovementBoundaryFrequencyEnum;
import com.nttdata.bankservice.model.document.type.AccountTypeEnum;
import com.nttdata.bankservice.model.document.type.ClientTypeEnum;
import com.nttdata.bankservice.model.repository.IAccountRepository;
import com.nttdata.bankservice.model.service.IAccountService;
...
public class AccountService implements IAccountService  {
	...
	private void validateAccount(Account account) throws Exception {
		...
		account.getClientIds()
			.forEach(x -> {
				if (x.startsWith(ClientTypeEnum.PERSONAL.getValue())) {
